...
export default function PopupDay2() {
  const { showDayTwo, setShowDayTwo } = usePopup();
  return (
    <>
      {showDayTwo ? (
        <div className="overlay-days">
          <div className="max-w-[1022px] w-full relative mb-[50px] top-[20px] left-0 md:left-[50%] md:translate-x-[-50%]">
                  ...
                  <ol className="text-grey3F text-[12px] md:text-[16px]">
                    ...
                    <li className="pl-[20px]">
                      ...
                      <p>
                        ...
                        du thuyền sẽ rời cảng Penang tiếp tục hành trình đến
                        <span className="font-bold">Phuket (Thái Lan)</span>.
